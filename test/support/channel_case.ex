defmodule LoanmanagementsystemWeb.ChannelCase do
  @moduledoc """
  ...
  by setting `use LoanmanagementsystemWeb.ChannelCase, async: true`, although
  ...
  using do
    quote do
      ...
      import LoanmanagementsystemWeb.ChannelCase
