...
$(document).ready(function() {
    $('.self-register-lookup').on('change', function() {
        if ($('#company_id').val() == "") {
            return false;
        }
        $.ajax({
            url: '/Employee/self/register/lookup',
            type: 'post',
            data: {
                "company_id": $('#company_id').val(),
                "_csrf_token": $("#csrf").val()
                        ...
                        return `
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a class="btn ripple btn-sm js-approve-product-other" data-product-id="${row.id}">Aprove</a>
                        ...
                        return `
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a class="btn ripple btn-sm js-disable-product" data-product-id="${row.id}">Disable</a>
...
$('#kt_datatable_stuff tbody').on('click', '.employer_activate_employee', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Are you sure you want to Proceed?',
...
$('#kt_datatable_staff_admin tbody').on('click', '.employer-activate-admin-employee', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/Admin/employer/activate/admin',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#kt_datatable_stuff').on('click', '.employer-deactivate-employee', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Activate this User?',
...
$('#kt_datatable_staff_admin').on('click', '.employer-deactivate-admin-employee', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Dasable this User?',
        text: "You won't be able to revert this!",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: '#23b05d',
        ...
        if (result.value) {
            $.ajax({
                url: '/Admin/employer/deactivate/admin',
                type: 'POST',
                data: { id: button.attr("data-deactivate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#kt_datatable_staff_admin tbody').on('click', '.employer-deactivate-admin-employee', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Are you sure you want to Proceed?',
...
var dt_all_employer_employee_loans = $('#dt_employer_employee_all_loans').DataTable({
    ...
    buttons:[
    {
        ...
        titleAttr: 'Generate CSV',
        className: 'btn-outline-primary btn-sm mr-1',
        messageTop: "Employee Loans Report",
        filename: "Employee Loans Report",
        exportOptions: {
    ...
    buttons:[
        {
            ...
            titleAttr: 'Generate CSV',
            className: 'btn-outline-primary btn-sm mr-1',
            messageTop: "Employee Loan Report",
            filename: "Employee Loan Report",
            exportOptions: {
                'columns': [  0, 1, 2, 3, 4, 5, 6, 7]
            }
        },
...
var dt_rejected_employer_employee_loans = $('#dt_employer_employee_rejected_loans').DataTable({
    ...
    buttons:[
    {
        ...
        titleAttr: 'Generate CSV',
        className: 'btn-outline-primary btn-sm mr-1',
        messageTop: "Employee Rejected Loans Report",
        filename: "Employee Rejected Loans Report",
        exportOptions: {
            'columns': [  0, 1, 2, 3, 4, 5, 6, 7]
        }
    },
...
var dt_all_disbursed_employer_employee_loans = $('#dt_employer_employee_disbursed_loans').DataTable({
    ...
    buttons:[
    {
        ...
        titleAttr: 'Generate CSV',
        className: 'btn-outline-primary btn-sm mr-1',
        messageTop: "Employee Disbursed Loans Report",
        filename: "Employee Disbursed Loans Report",
        exportOptions: {
            'columns': [  0, 1, 2, 3, 4, 5, 6, 7]
        }
    },
...
$('#').click(function() {
    ...
    var principal_amount = document.getElementById('numberInput').value;
    var months = document.getElementById('months').value;
    var loan_limit_balance = document.getElementById('loan_limit_balance').value;
    ...
    if(principal_amount <= loan_limit_balance){
        if (principal_amount === "") 
        {
            Swal.fire({
                title: ("please provide loan amount"),
    ...
    else if(principal_amount > loan_limit_balance){
        Swal.fire({
            title: "<strong> LOAN INITIATION DECLINED</strong>",
            icon: "info",
            html: `This loan initiation declined because the amount proposed is more than the maximum loan limit. Client limit balance is K` + loan_limit_balance,
            type: "warning",
            showCancelButton: false,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#d33',
...
$('#employee-module-salary-loan_application').click(function() {
    ...
    Swal.fire({
        ...
        if (result.value) {
                $('#emp_module_salary_advance_loan_application').attr('action', '/employee/salary/advance/loan/application');
                $('#emp_module_salary_advance_loan_application').attr('method', 'POST');
                $("#emp_module_salary_advance_loan_application").submit();
