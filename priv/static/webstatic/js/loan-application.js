...

        {
            ...
            "render": function(data, type, row) {
                ...
                if ($('#usertype').val() == "Operations" && row.loan_status == "PENDING_OPERATIONS_MANAGER"){
                    if ($('#change_status').val() == "Y" ){
                        return ` 
                            <a  href="/pending/operations/application/approval?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}"  class=" btn ripple btn-success btn-sm "><i class= "ki ki-check icon-sm"></i>Submit</a>
                            <a  href="#" data-id="${row.id}" data-toggle="#loan-reject-modal" data-toggle="modal"  class=" btn ripple btn-danger btn-sm "><i class= "ki ki-close icon-sm"></i>Reject</a>
                            <a href="/view/universal/loan/application?userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}" class=" btn ripple btn-info btn-sm "><i class= "flaticon-eye icon-sm"></i> View</a>
                ...
                if ($('#usertype').val() == "Management" && row.loan_status == "PENDING_MANAGEMENT"){
                    if ($('#change_status').val() == "Y" ){
                        return ` 
                            <a  href="/pending/executive/committe/approval?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}"  class=" btn ripple btn-success btn-sm "><i class= "ki ki-check icon-sm"></i>Submit</a>
                            <a  href="#"  data-id="${row.id}" data-toggle="#loan-reject-modal" data-toggle="modal" class=" btn ripple btn-danger btn-sm "><i class= "ki ki-close icon-sm"></i>Reject</a>
                            <a href="/view/universal/loan/application?userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}" class=" btn ripple btn-info btn-sm "><i class= "flaticon-eye icon-sm"></i> View </a>
           ...
           // "render": function(data, type, row) {
            ...
            "render": function(data, type, row) {
                ...
                if (row.loan_type == "SME LOAN") {
                    return `  
                    <a href="/View/All/Documents/Per/loan?loan_id=${row.id}&userId=${row.userId}" class="btn ripple btn-info btn-sm "><i class= "flaticon-eye icon-sm"></i> Documents </a>
                `;
                } 

                if (row.loan_type == "SALARY ADVANCE") {
                    return `
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a class="btn ripple btn-sm" href="/View/All/Documents/Per/loan?loan_id=${row.id}&userId=${row.userId}">Documents</a>

                            <a class="btn ripple btn-sm" href="/view/universal/loan/application?loan_id=${row.id}&&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}">View</a>
        ...
        },
        {
            ...
            "render": function(data, type, row) {
                ...
                if ($('#usertype').val() == "Accounts" && row.loan_status == "PENDING_ACCOUNTANT_DISBURSEMENT"){
                    if ($('#change_status').val() == "Y" ){
                        return `  
                        <a href="/Accountant/invoice/discounting/approval?loan_id=${row.id}"class="btn ripple btn-success btn-sm"><i class= "flaticon-edit-1 icon-sm"></i>Disburse</a>
                ...
                if ($('#usertype').val() == "Credit" && row.loan_status == "PENDING_CREDIT_ANALYST"){
                    if ($('#change_status').val() == "Y" ){
                        return `  
                        <a href="/Approve/Credit/Invoice/Discounting/Loan?loan_id=${data}"class="btn ripple btn-success btn-sm"><i class= "flaticon-edit-1 icon-sm"></i>Review</a>
                ...
                if ($('#usertype').val() == "Credit" && row.loan_status == "APPROVED"){
                    if ($('#change_status').val() == "Y" ){
                        return `  
                        <a href="/Approve/Credit/Invoice/Discounting/Loan?loan_id=${data}"class="btn ripple btn-success btn-sm"><i class= "flaticon-edit-1 icon-sm"></i>Attach</a>
                ...
                if ($('#usertype').val() == "Operations" && row.loan_status == "PENDING_OPERATIONS_MANAGER"){ 
                    ...
                    if ($('#change_status').val() == "Y" ){
                        return ` 
                            <a  href="/pending/operations/application/approval?userId=${my_user_id}&loan_id=${row.id}&product_id=${row.product_id}&reference_no=${row.reference_no}"  class=" btn ripple btn-success btn-sm "><i class= "ki ki-check icon-sm"></i>Review</a>
                ...
                if ($('#usertype').val() == "Management" && row.loan_status == "PENDING_MANAGEMENT"){
                    if ($('#change_status').val() == "Y" ){
                        return ` 
                            ...
                            <a href="/Mgt/View/Invoice/Discounting/Loan?loan_id=${row.id}" class="btn ripple btn-success btn-sm"><i class="ki ki-check icon-sm"></i> Approve</a>
    ...
    "columns": [
...

        {
            ...
            render: function(data, _, row) {
                ...
                if (data === "PENDING_SENIOR_OFFICER") {
                    show = "<td><span class='btn ripple btn-warning btn-sm'> PENDING SENIOR OFFICER </span></td>";
                }

                if (data === "PENDING_FINANCE_OFFICER") {
                    show = "<td><span class='btn ripple btn-warning btn-sm'> PENDING FINANCE OFFICER </span></td>";
                }
...

        {
            ...
            "render": function(data, type, row) {
                ...
                if ($('#usertype').val() == "Credit" && row.loan_status == "FROM_MGT_TO_CREDIT_ANALYST"){
                    if ($('#change_status').val() == "Y" ){
                        return ` 
                            <a  href="/view/loan/application/pending/credit/from/mgt?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}"  class=" btn ripple btn-success btn-sm "><i class= "ki ki-check icon-sm"></i>Submit</a>
                            <a href="/view/universal/loan/application?userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}" class=" btn ripple btn-info btn-sm "><i class= "flaticon-eye icon-sm"></i> View </a>
                ...
                if ($('#usertype').val() != "Loan Officer" || "Senior Loan Officer" || "Finance Officer"){
                    if ($('#change_status').val() == "N" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                            <div class="dropdown-content">
                ...
                if ($('#usertype').val() == "Loan Officer" && row.loan_status == "PENDING_APPROVAL"){
                    if ($('#change_status').val() == "N" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                ...
                if ($('#usertype').val() == "Loan Officer" && row.loan_status == "PENDING_FINANCE_OFFICER"){
                    if ($('#change_status').val() == "N" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                ...
                if ($('#usertype').val() == "Loan Officer" && row.loan_status == "DISBURSED"){
                    if ($('#change_status').val() == "N" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                ...
                if ($('#usertype').val() == "Senior Loan Officer" && row.loan_status == "PENDING_APPROVAL"){
                    if ($('#change_status').val() == "Y" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                            <div class="dropdown-content">
                                ...
                                <a class="btn ripple btn-sm" href="/Approved/Senior/Loan/Officer?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}">Approve</a>

                                <a class="btn ripple btn-sm" data-id="${row.id}" data-target="#rejectmodal" data-toggle="modal" href="#">Reject</a>
                ...
                if ($('#usertype').val() == "Finance Officer" && row.loan_status == "PENDING_FINANCE_OFFICER"){
                    if ($('#change_status').val() == "Y" ){ 
                        return ` 
                        <div class="dropdown">
                            <button class="dropbtn">Options</button>
                            <div class="dropdown-content">
                                ...
                                <a class="btn ripple btn-sm" href="/Disbursed/Finance/Loan/Officer?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}">Disburse</a>
                        ...
                        return `
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a class="btn ripple btn-sm" href="/pending/executive/committe/approval?loan_id=${row.id}&userId=${row.userId}&product_id=${row.productId}&reference_no=${row.reference_no}">Submit</a>
