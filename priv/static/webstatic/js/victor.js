...
var defaults_report_miz = $('#defaults_report_miz').DataTable({
    "responsive": true,
    "processing": true,
    "bFilter": false,
    "select": {
    ...
    "dom": `<'row'<'col-sm-6 text-left'f><'col-sm-6 text-right'B>>
        ...
        "buttons":[
            ...
            "extend": 'csvHtml5',
            "text": 'Excel',
            "titleAttr": 'Defaulters Report',
            "className": "btn-outline-primary btn-sm mr-1",
            "messageTop": "Defaulters Report",
    ...
    'ajax': {
        "type": "POST",
        "url": '/Admin/report/customer/defaulters',
        "data": {
            _csrf_token: $("#csrf").val(),
...
var employers_report_miz = $('#employers_report_miz').DataTable({
    "responsive": true,
    "processing": true,
    "bFilter": true,
    "select": {
    ...
    "dom": `<'row'<'col-sm-6 text-left'f><'col-sm-6 text-right'B>>
        ...
        "buttons":[
            ...
            "extend": 'csvHtml5',
            "text": 'Excel',
            "titleAttr": 'Employers Report',
            "className": "btn-outline-primary btn-sm mr-1",
            "messageTop": "Employers Report",
            "filename": "Employers Report",
            "exportOptions": {
                'columns': [  0, 1, 2, 3, 4, 5, 6, 7,8]
            }
            },
    ...
    'ajax': {
        "type": "POST",
        "url": '/Admin/report/customer/employers',
        "data": {
            _csrf_token: $("#csrf").val(),
...
var blackliast_client_report_miz = $('#blackliast_client_report_miz').DataTable({
    "responsive": true,
    "processing": true,
    "bFilter": true,
    "select": {
    ...
    "dom": `<'row'<'col-sm-6 text-left'f><'col-sm-6 text-right'B>>
        ...
        "buttons":[
            ...
            "extend": 'csvHtml5',
            "text": 'Excel',
            "titleAttr": 'Blacklisted Clients Report',
            "className": "btn-outline-primary btn-sm mr-1",
            "messageTop": "Blacklisted Clients Report",
            "filename": "Blacklisted Clients Report",
            "exportOptions": {
                'columns': [  0, 1, 2, 3, 4, 5, 6, 7,8]
            }
            },
    ...
    'ajax': {
        "type": "POST",
        "url": '/Admin/report/customer/blacklisted',
        "data": {
            _csrf_token: $("#csrf").val(),
...
var employers_employees_report_item_lookup = $('#employers_employees_report_item_lookup').DataTable({
    "responsive": true,
    "processing": true,
    "bFilter": true,
    "select": {
    ...
    'ajax': {
        "type": "POST",
        "url": '/Admin/report/customer/employees',
        "data": {
            _csrf_token: $("#csrf").val(),
