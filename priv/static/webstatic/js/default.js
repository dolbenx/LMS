...
$('#example1 tbody').on('click', '.activate-company', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/view/system/company/activate',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1').on('click', '.activate-admin-document', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Are you sure you want to Proceed?',
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/system/management/maintainence/documents/activate',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1').on('click', '.deactivate-admin-document', function(e) {
    e.preventDefault();
    let button = $(this)
    Swal.fire({
        title: 'Are you sure you want to Proceed?',
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/system/management/maintainence/documents/deactivate',
                type: 'POST',
                data: { id: button.attr("data-deactivate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1 tbody').on('click', '.activatebank', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/maintenance/bank/activate',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1 tbody').on('click', '.deactivatebank', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/maintenance/bank/deactivate',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1 tbody').on('click', '.activate-client', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/client/maintain/activate_client',
                type: 'POST',
                data: { id: button.attr("data-activate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
...
$('#example1 tbody').on('click', '.deactivate-client', function(e) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: '/admin/client/maintain/deactivate_client',
                type: 'POST',
                data: { id: button.attr("data-deactivate-id"), _csrf_token: $('#csrf').val() },
                success: function(result) {
                    if (result.data) {
