...
(function(S, M) {
	...
	M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function(a) {
		...
		function G(d, k) {
			const b = {};
			J(d, function(f, E) {
				if(C(d[E], !0) && !d.nodeType && k[E]) f = G(d[E], k[E]), Object.keys(f).length && (b[E] = f);
		...
		function F(d, b, f) {
			...
			function e(f) {
				...
				d.nodeName && (b ? (e = {}, e[b] = !0) : e = f, J(e, function(d, b) {
					if(f[b])
						for(K = f[b].length; K--;) k(b, f[b][K].fn)
				}))
			}
	...
	M(a, "Core/Color/Color.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y) {
		...
		class D {
			...
			init(a) {
				let z;
				let t;
				if("object" === typeof a && "undefined" !== typeof a.stops) this.stops = a.stops.map(c => new D(c[1]));
					...
					if(!z)
						for(c = D.parsers.length; c-- && !z;) t = D.parsers[c], (v = t.regex.exec(a)) && (z = t.parse(v))
				}
				z && (this.rgba = z)
			}
			get(a) {
			...
			brighten(a) {
				...
				if(this.stops) this.stops.forEach(function(t) {
					...
					for(let t = 0; 3 > t; t++) z[t] += A(255 * a), 0 > z[t] && (z[t] = 0), 255 < z[t] && (z[t] = 255);
				return this
			}
			setOpacity(a) {
				this.rgba[3] = a;
	...
	M(a, "Core/Color/Palettes.js", [], function() {
		return {
			colors: "#24BFCD #5CD0DE #8ADDE7 #02d9f2 #35dcf0 #00e272 #fe6a35 #6b8abc #d568fb #2ee0ca #fa4b42 #feb56a #91e8e1".split(" ")
		}
	});
	M(a, "Core/Time.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y) {
		const {
			...
			splat: n,
			timeUnits: r
		} = y, l = a.isSafari && x.Intl && x.Intl.DateTimeFormat.prototype.formatRange, h = a.isSafari && x.Intl && !x.Intl.DateTimeFormat.prototype.formatRange;
		class q {
			constructor(g) {
				this.options = {};
	...
	M(a, "Core/Animation/Fx.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, G) {
		...
		class z {
			...
			update() {
				...
				else a.attr ? a.element && a.attr(v, c, null, !0) : a.style[v] = c + this.unit;
				n && n.call(a, c, this)
			}
			run(a, v, c) {
				const n = this,
			...
			initPath(a, v, c) {
				...
				function r(e, m) {
					for(; e.length < J;)
						if(m = e[Math.floor(e.length / g) - 1].slice(), "C" === m[0] && (m[1] = m[5], m[2] = m[6]), q) {
	...
	M(a, "Core/Renderer/HTML/AST.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y) {
		...
		class q {
			static filterUserAttributes(g) {
				c(g, (c, l) => {
					let a = !0; - 1 === q.allowedAttributes.indexOf(l) && (a = !1); - 1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(l) && (a = v(c) && q.allowedReferences.some(e => 0 === c.indexOf(e)));
					a || (z(33, !1, void 0, {
			...
			parseMarkup(g) {
				...
				if(h) g = (new DOMParser).parseFromString(r ? r.createHTML(g) : g, "text/html");
				else {
					const c = D("div");
					c.innerHTML = g;
					g = {
	...
	M(a, "Core/Renderer/SVG/SVGElement.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, G, L) {
		...
		class N {
			...
			applyTextOutline(b) {
				const d = this.element; - 1 !== b.indexOf("contrast") && (b = b.replace(/contrast/g, this.renderer.getContrast(d.style.fill)));
				var f = b.split(" ");
				b = f[f.length - 1];
			...
			shadow(b) {
				...
				const {
					renderer: f
				} = this, k = H(90 === (null === (d = this.parentGroup) || void 0 === d ? void 0 : d.rotation) ? {
					offsetX: -1,
					offsetY: -1
				} : {}, u(b) ? b : {});
			...
			zIndexSetter(b, f) {
				...
				if(l) {
					...
					for(B = f.length - 1; 0 <= B && !c; B--)
						if(e = f[B], l = e.getAttribute("data-z-index"), a = !g(l), e !== m)
							if(0 > b && a && !k && !B) p.insertBefore(m, f[B]), c = !0;
							else if(d(l) <= b || a && (!g(b) || 0 <= b)) p.insertBefore(m, f[B + 1]), c = !0;
	...
	M(a, "Core/Renderer/SVG/TextBuilder.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, G) {
		...
		class r {
			...
			buildSVG() {
				...
				q = !c.added && q.box;
				const F = /<br.*?>/g;
				var e = [g, this.ellipsis, this.noWrap, this.textLineHeight,
					this.textOutline, c.getStyle("font-size"), this.width
				].join();
				if(e !== c.textCache) {
					c.textCache = e;
			...
			modifyDOM() {
				...
				for(; q = a.element.firstChild;)
					if(/^[\s\u200B]*$/.test(q.textContent || " ")) a.element.removeChild(q);
					else break;
				...
				if(g) {
					var w = (q, e) => {
							...
							let b = 0,
								f = a.actualWidth;
							if(this.ellipsis) m && this.truncate(q, m, void 0, 0, Math.max(0, g - .8 * l), (b, f) => b.substring(0, f) + "\u2026");
							else if(p) {
								m = [];
			...
			modifyTree(a) {
				const c = (q, g) => {
					const {
						...
						style: n = {},
						tagName: e
					} = q, m = this.renderer.styledMode;
					if("b" === e || "strong" === e) m ? h["class"] = "highcharts-strong" : n.fontWeight = "bold";
					else if("i" === e || "em" === e) m ? h["class"] = "highcharts-emphasized" : n.fontStyle = "italic";
	...
	M(a, "Core/Renderer/SVG/SVGRenderer.js", [a["Core/Renderer/HTML/AST.js"], a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Renderer/SVG/Symbols.js"], a["Core/Renderer/SVG/TextBuilder.js"], a["Core/Utilities.js"]], function(a, y, G, L, A, D, C, z, t) {
		...
		class K {
			...
			init(b, d, f, k, a, p, m) {
				...
				b.appendChild(c);
				e(b, "dir", "ltr"); - 1 === b.innerHTML.indexOf("xmlns") && e(c, "xmlns", this.SVG_NS);
				this.box = c;
				this.boxWrapper = B;
				this.alignedObjects = [];
		...
		class h {
			...
			handleOverflow(a) {
				...
				let k = f,
					O = 1,
					N;
				if(p || "justify" !== h.overflow) 0 > p && n - r * b < m ? N = Math.round(n / Math.cos(p * x) - m) : 0 < p && n + r * b > e && (N = Math.round((q - n) / Math.cos(p * x)));
				else if(q = n + (1 - r) * b, n - r * b < m ? k = a.x + k * (1 - r) - m : q > e && (k = e - a.x + k * r, O = -1), k = Math.min(f, k), k < f && "center" === c.labelAlign && (a.x += O * (f - k - r * (f - Math.min(b, k)))), b > k || c.autoRotation && (u.styles || {}).width) N = k;
	...
	M(a, "Core/Axis/Axis.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Axis/AxisDefaults.js"], a["Core/Color/Color.js"], a["Core/Defaults.js"], a["Core/Foundation.js"], a["Core/Globals.js"], a["Core/Axis/Tick.js"], a["Core/Utilities.js"]], function(a, y, G, L, A, D, C, z) {
		const {
			...
			splat: E,
			syncTimeout: Z
		} = z, T = (b, d) => f(d, void 0, void 0, k(b.options.allowDecimals, .5 > d || void 0 !== b.tickAmount), !!b.tickAmount);
		class U {
			constructor(b, d) {
			...
			init(b, d) {
				...
				this.crosshair = !0 === d ? {} : d; - 1 === b.axes.indexOf(this) && (a ? b.axes.splice(b.xAxis.length, 0, this) : b.axes.push(this), b[this.coll].push(this));
			...
			defaultLabelFormatter(b) {
				...
				if(d.categories) K = `${this.value}`;
					...
					for(; g-- && "undefined" === typeof K;) d = Math.pow(e, g + 1), m >= d && 0 === 10 * f % d && null !== c[g] && 0 !== f && (K = b(f / d, -1) + c[g]);
				...
				m(this, "getSeriesExtremes", null, function() {
					...
					b.series.forEach(function(a) {
						if(a.visible || !d.options.chart.ignoreHiddenSeries) {
							...
							if(b.isXAxis)(e = a.xData) && e.length && (e = b.logarithmic ? e.filter(b => 0 < b) : e, f = a.getXExtremes(e), c = f.min, m = f.max, p(c) || c instanceof Date || (e = e.filter(p), f = a.getXExtremes(e), c = f.min, m = f.max), e.length && (b.dataMin = Math.min(k(b.dataMin, c), c), b.dataMax = Math.max(k(b.dataMax, m), m)));
							else if(a = a.applyExtremes(), p(a.dataMin) && (c = a.dataMin, b.dataMin = Math.min(k(b.dataMin, c), c)), p(a.dataMax) && (m = a.dataMax, b.dataMax = Math.max(k(b.dataMax, m), m)), g(d) && (b.threshold = d), !e.softThreshold || b.positiveValuesOnly) b.softThreshold = !1
						}
					})
				});
			...
			getPlotLinePath(b) {
				...
				m(this, "getPlotLinePath", b, function(b) {
					...
					b.path = H && !E ? null : f.renderer.crispLine([
						["M", w, O],
						["L", N, X]
					], l || 1)
				});
			...
			getMinorTickPositions() {
				...
				if(e && e / a < this.len / 3) {
					...
					else if(this.dateTime && "auto" === this.getMinorTickInterval()) c = c.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(a), k, f, b.startOfWeek));
					else
						for(b = k + (d[0] - k) % a; b <= f && b !== c[0]; b += a) c.push(b)
				}
			...
			nameToX(b) {
				...
				g(f) || (f = this.options.uniqueNames && a ? d ? a.indexOf(b.name) : k(a.keys[b.name], -1) : b.series.autoIncrement()); - 1 === f ? !d && a && (e = a.length) : e = f;
			...
			setTickPositions() {
				...
				if(d) k = d.slice();
					...
					if(this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)))
						if(this.dateTime) k = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, b.units), this.min, this.max, b.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0);
						else if(this.logarithmic) k = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);
					else
						for(f = b = this.tickInterval; f <= 2 * b;)
							if(k = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && k.length > this.tickAmount) this.tickInterval = T(this, f *= 1.1);
							else break;
					else k = [this.min, this.max],
						x(19, !1, this.chart);
			...
			trimTicks(b, d, a) {
				...
				if(!this.isLinked) {
					if(d && -Infinity !== f) this.min = f;
						...
						for(; this.min - e > b[0];) b.shift();
					if(a) this.max = k;
					else
						for(; this.max + e < b[b.length - 1];) b.pop();
			...
			unsquish() {
				...
				if(d) {
					if(b.staggerLines || (p(e) ? r = [e] : a < b.autoRotationLimit && (r = b.autoRotation)), r) {
						let b;
						for(const f of r)
							if(f === e || f && -90 <= f && 90 >= f) d = g(Math.abs(c / Math.sin(n * f))), b = d + Math.abs(f / 360), b < u && (u = b, l = f, h = d)
					}
				} else h = g(c);
				this.autoRotation = r;
			...
			renderUnsquish() {
				...
				if(this.autoRotation) r > m && r > h.h ? g.rotation = this.labelRotation : this.labelRotation = 0;
				else if(p && (u = m, !l))
			...
			getLinePath(b) {
				...
				return d.renderer.crispLine([
					...
					["L", e ? d.chartWidth - this.right : k, e ? a : d.chartHeight - this.bottom]
				], b)
			}
			renderLine() {
		...
		(function(y) {
			...
			class v {
				...
				getLogTickPositions(a, n, r, l) {
					...
					if(.5 <= a) a = Math.round(a), w = c.getLinearTickPositions(a, n, r);
					else if(.08 <= a) {
						g = Math.floor(n);
						let c, h, e, m, u;
						for(q = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; g < r + 1 && !u; g++)
							for(h = q.length, c = 0; c < h && !u; c++) e = this.log2lin(this.lin2log(g) * q[c]), e > n && (!l || m <= r) && "undefined" !== typeof m && w.push(m), m > r && (u = !0), m = e
	...
	M(a, "Core/Axis/PlotLineOrBand/PlotLineOrBandAxis.js", [a["Core/Utilities.js"]], function(a) {
		...
		(function(y) {
			...
			function v(a, c, h = this.options) {
				...
				let m;
				if(a && g)
					for(c && (m = a.toString() === g.toString(), h = 0), c = 0; c < a.length; c += 2) {
						const u = a[c],
							p = a[c + 1],
							n = g[c],
							b = g[c + 1];
	...
	M(a, "Core/Tooltip.js", [a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Renderer/RendererRegistry.js"], a["Core/Utilities.js"]], function(a, y, G, L, A) {
		...
		class u {
			...
			getAnchor(a, c) {
				...
				if(this.followPointer && c) "undefined" === typeof c.chartX && (c = f.normalize(c)), a = [c.chartX - b, c.chartY - k];
		...
		class H {
			...
			optionsToObject(b) {
				...
				if(g(b) || null === b) m[e[0]] = b;
					...
					for(!d && b.length > c && (a = typeof b[0], "string" === a ? m.name = b[0] : "number" === a && (m.x = b[0]), p++); l < c;) d && "undefined" === typeof b[p] || (0 < e[l].indexOf(".") ? H.prototype.setNestedProperty(m, b[p], e[l]) : m[e[l]] = b[p]), p++, l++;
				else "object" === typeof b && (m = b, b.dataLabels && (a._hasPointLabels = !0), b.marker && (a._hasPointMarkers = !0));
				return m
			}
			pos(b, a = this.plotY) {
				if(!this.destroyed) {
	...
	M(a, "Core/Pointer.js", [a["Core/Color/Color.js"], a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, y, G) {
		...
		class F {
			...
			drag(a) {
				...
				if(!t || !t.touch)
					if(q < g ? q = g : q > g + b && (q = g + b), w < l ? w = l : w > l + f && (w = l + f), this.hasDragged = Math.sqrt(Math.pow(d - q, 2) + Math.pow(k - w, 2)), 10 < this.hasDragged) {
			...
			drop(a) {
				...
				if(this.selectionMarker) {
					const {
						...
						width: f,
						height: d
					} = this.getSelectionBox(this.selectionMarker), k = {
						originalEvent: a,
						xAxis: [],
						yAxis: [],
						x: m,
			...
			pinchTranslateDirection(a, c, g, p, h, b, f, d) {
				...
				R ? (I -= .8 * (I - f[m][0]), "number" === typeof V && (V -= .8 * (V - f[m][1])), c()) : f[m] = [I,
					V
				];
				q || (b[m] = B - u, b[r] = H);
				b = q ? 1 / P : P;
	...
	M(a, "Core/Legend/Legend.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Core/Series/Point.js"], a["Core/Renderer/RendererUtilities.js"], a["Core/Utilities.js"]], function(a, y, G, L, A, D) {
		...
		class H {
			...
			render() {
				...
				var l = b.spacingBox.width - 2 * c - d.x; - 1 < ["rm", "lm"].indexOf(this.getAlignment().substring(0, 2)) && (l /= 2);
		...
		class da {
			...
			temporaryDisplay(b) {
				...
				if(b)
					for(; a && a.style;) a.hcOrigStyle && (O(a, a.hcOrigStyle), delete a.hcOrigStyle),
						a.hcOrigDetached && (e.body.removeChild(a), a.hcOrigDetached = !1), a = a.parentNode;
				else
					for(; a && a.style;) {
			...
			reflow(b) {
				...
				if(!d && !a.isPrinting && f && e.width) {
					if(e.width !== f.width || e.height !== f.height) c.clearTimeout(a.reflowTimeout),
						a.reflowTimeout = ha(function() {
			...
			update(b, a, c, f) {
				...
				if(n) {
					...
					V(n, function(b, a) {
						-1 !== e.propsRequireUpdateSeries.indexOf("chart." + a) && (p = !0); - 1 !== e.propsRequireDirtyBox.indexOf(a) && (e.isDirtyBox = !0); - 1 !== e.propsRequireReflow.indexOf(a) && (m ? e.isDirtyBox = !0 : l = !0)
					});
				...
				V(b, function(a, d) {
					...
					else "colors" !== d && -1 === e.collectionsWithUpdate.indexOf(d) && I(!0, e.options[d], b[d]);
		...
		class Y {
			...
			findPointIndex(b, a) {
				...
				if(c) g = this.chart.get(c), g instanceof D && (k = g);
					...
					if(k = a => !a.touched && a.index === b.index, g && g.matchByName ? k = a => !a.touched && a.name === b.name : this.options.relativeXValue && (k = a => !a.touched && a.options.x === b.x), k = d(e, k), !k) return;
				k && (h = k && k.index, "undefined" !== typeof h && (m = !0));
				"undefined" === typeof h && E(f) && (h = this.xData.indexOf(f, a)); - 1 !== h && "undefined" !== typeof h && this.cropped && (h = h >= this.cropStart ? h - this.cropStart : h);
			...
			updateData(b, a) {
				...
				if(m)
					for(b = f.length; b--;)(h = f[b]) && !h.touched && h.remove && h.remove(!1, a);
				else !k || c && c.enabled ? n = !1 : (b.forEach(function(b, a) {
				...
				if(!t) {
					...
					if(r && P > r)
						if(x = g.getFirstValidPoint(a), E(x))
							for(c = 0; c < P; c++) q[c] = this.autoIncrement(), u[c] = a[c];
						else if(N(x))
						if(B)
							if(x.length === B)
								for(c = 0; c < P; c++) q[c] = this.autoIncrement(), u[c] = a[c];
							else
								for(c = 0; c < P; c++) f = a[c], q[c] = f[0], u[c] = f.slice(1, B + 1);
					else if(w && (I = w.indexOf("x"), v = w.indexOf("y"), I = 0 <= I ? I : 0, v = 0 <= v ? v : 1), 1 === x.length && (v = 0), I === v)
						for(c = 0; c < P; c++) q[c] = this.autoIncrement(), u[c] = a[c][v];
					else
						for(c = 0; c < P; c++) f = a[c], q[c] = f[I], u[c] = f[v];
					else b(12, !1, p);
					else
						for(c = 0; c < P; c++) f = {
							series: g
			...
			generatePoints() {
				...
				this.options.keys = p;
				if(u && (g !== (n = u.length) || h))
					for(q = 0; q < n; q++) q !== m || h || (q += g), u[q] && (u[q].destroyElements(), u[q].plotX = void 0);
				this.data = u;
				this.points = l;
			...
			translate() {
				...
				const a = this.options,
					...
					t = this.zoneAxis || "y";
				let v, x, J, F, H = Number.MAX_VALUE;
				for(v = 0; v < l; v++) {
					const k = h[v],
						l = k.x;
					let B, I, P = k.y,
			...
			setClip() {
				const {
					...
					group: a,
					markerGroup: d
				} = this, c = b.sharedClips, f = b.renderer, e = this.getClipBox(), g = this.getSharedClipKey();
				let k = c[g];
			...
			animate(b) {
				...
				}), a.sharedClips[k + "m"] = h), d.clip(m), f && f.clip(h);
				...
				if(!1 !== e.enabled || this._hasPointMarkers)
					for(h = 0; h < b.length; h++) {
						...
						if((m && "undefined" === typeof u.enabled || u.enabled) && !p.isNull && !1 !== p.visible) {
							...
							if(l)
								if(u = this.pointAttribs(p, d || !p.selected ? void 0 : "select"), d) c && l.css({
									fill: u.fill
								});
								else l[n](u);
			...
			update(a, d) {
				...
				const q = {};
				let r, u = ["eventOptions", "navigatorSeries", "baseSeries"],
				...
				if(w[t]) {
					if(p = t !== c.type, c.remove(!1, !1, !1, !0), p)
						if(Object.setPrototypeOf) Object.setPrototypeOf(c, w[t].prototype);
						else {
		...
		class D extends a {
			...
			getGraphPath(a, z, t) {
				...
				a.forEach(function(g, q) {
					...
					m && !x(z) && 0 < q ? l = !c.connectNulls : m && !z ? l = !0 : (0 === q || l ? q = [
						["M", g.plotX, g.plotY]
					] : v.getPointSpline ? q = [v.getPointSpline(a, g, q)] : h ? (q = 1 === h ? [
						["L", e.plotX, F]
					] : 2 === h ? [
						["L", (e.plotX + w) / 2,
							e.plotY
						...
						["L", w, F]
					], r.push(g.x), h && (r.push(g.x), 2 === h && r.push(g.x)), n.push.apply(n, q), l = !1)
				});
				n.xMap = r;
		...
		class e extends A {
			...
			translate() {
				...
				a.points.forEach(function(m) {
					...
					m.barX = z;
					m.pointWidth = H;
					m.tooltipPos = c.inverted ? [n(f.len + f.pos - c.plotLeft - l, f.pos - c.plotLeft, f.len + f.pos - c.plotLeft), b.len + b.pos - c.plotTop - z - A / 2, E] : [b.left - c.plotLeft + z + A / 2, n(l + f.pos - c.plotTop, f.pos - c.plotTop, f.len + f.pos - c.plotTop),
						E
					];
			...
			function e(b = this.points) {
				...
				if(t(q) || q.enabled || a._hasPointLabels) F = this.initDataLabels(J), b.forEach(b => {
					...
					w.forEach((f, g) => {
						...
						let l, q, u = b.dataLabels ? b.dataLabels[g] : b.dataLabel,
							w = !u;
		...
		C(c.prototype, {
			connectorShapes: {
				fixedOffset: function(a, c, l) {
					...
					c = c.touchingSliceAt;
					return [
						["M", a.x, a.y], l.softConnector ? ["C", a.x + ("left" === a.alignment ? -5 : 5), a.y, 2 * h.x - c.x, 2 * h.y - c.y, h.x, h.y] : ["L", h.x, h.y],
						["L", c.x, c.y]
					]
				},
				...
				crookedLine: function(a, c, l) {
					...
					const [g, r, t] = c.center, x = t / 2, e = c.chart.plotWidth, m = c.chart.plotLeft;
					c = "left" === a.alignment;
					const {
						x: u,
						y: p
					...
					(c ? a <= u && a >= h.x : a >= u && a <= h.x) && l.push(["L",
						a, p
					]);
		...
		a.prototype.hideOverlappingLabels = function(a) {
			...
			var y = function(a) {
				...
				if(a && (!a.alignAttr || a.placed)) return c = a.alignAttr || {
						x: a.attr("x"),
						y: a.attr("y")
					}, e = a.parentGroup, a.width || (g = a.getBBox(), a.width = g.width, a.height = g.height, g = r.fontMetrics(a.element).h),
					f = a.width - 2 * h, (d = {
						left: "0",
						center: "0.5",
						right: "1"
			...
			for(h = 0; h < n; h++)
				if(l = a[h]) l.oldOpacity = l.opacity, l.newOpacity = 1, l.absoluteBox = y(l);
			a.sort(function(a, c) {
				return(c.labelrank || 0) - (a.labelrank || 0)
			});
			for(h = 0; h < n; h++)
				for(g = (y = a[h]) && y.absoluteBox, l = h + 1; l < n; ++l) t = (q = a[l]) && q.absoluteBox, !g || !t || y === q || 0 === y.newOpacity || 0 === q.newOpacity || "hidden" === y.visibility || "hidden" === q.visibility || t.x >= g.x + g.width || t.x + t.width <= g.x || t.y >= g.y + g.height || t.y + t.height <= g.y || ((y.labelrank < q.labelrank ? y : q).newOpacity = 0);
			a.forEach(function(a) {
				x(a, c) && (v = !0)
			});
				...
				function c(a, h, l, n) {
					...
					C(a, function(a, f) {
						if(!n && -1 < g.collectionsWithUpdate.indexOf(f) && h[f])
							for(a = t(a), l[f] = [], e = 0; e < Math.max(a.length, h[f].length); e++) h[f][e] && (void 0 === a[e] ? l[f][e] = h[f][e] : (l[f][e] = {}, c(a[e], h[f][e], l[f][e], n + 1)));
						else A(a) ? (l[f] = L(a) ? [] : {}, c(a, h[f] || {}, l[f], n + 1)) : l[f] = "undefined" === typeof h[f] ? null : h[f]
					})
				}
				const g = this,
					h = {};
	...
	], function(a, y, G, L, A, D, C, z, t, v, c, n, r, l, h, q, g, w, J, F, e, m, u, p, H, b, f, d, k, M, N, E, S, T) {
		a.animate = A.animate;
