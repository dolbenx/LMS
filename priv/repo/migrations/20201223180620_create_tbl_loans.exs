defmodule Loanmanagementsystem.Repo.Migrations.CreateTblLoans do
  ...
  def change do
    create table(:tbl_loans) do
      ...
      add :mobile_money_response, :string
      add :total_principal_repaid, :float
      add :total_interest_repaid, :float
      add :total_charges_repaid, :float
      add :total_repaid, :float
      add :total_penalties_repaid, :float
