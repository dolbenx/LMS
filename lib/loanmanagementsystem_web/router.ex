defmodule LoanmanagementsystemWeb.Router do
  ...
  pipeline :report_app do
    # plug(LoanmanagementsystemWeb.Plugs.RequireAdminAccess)
    plug(:put_layout, {LoanmanagementsystemWeb.LayoutView, :report_app})
  end
  ...
  scope "/", LoanmanagementsystemWeb do
    ...
    get("/get/internal/server/error/view", SessionController, :internal_server_error)
  end
  ...
  scope "/", LoanmanagementsystemWeb do
    ...
    get("/Admin/maintain/email/sender", MaintenanceController, :admin_configure_email_sender)
    get("/Admin/maintain/email/receiver", MaintenanceController, :admin_configure_email_receiver)
    post("/Admin/maintain/crete/email/receiver", MaintenanceController, :create_receiver_email)
    post("/Admin/maintain/edit/email/receiver", MaintenanceController, :admin_update_email_receiver)
    post("/Admin/maintain/crete/emails/sender", MaintenanceController, :create_emails_sender)
    post("/Admin/maintain/edit/email/sender", MaintenanceController, :admin_update_emails_sender)
    ...
    post("/Update/corperate/funders/Funds", UserController, :admin_corperate_update_funders_funds)
    get("/Admin/View/Corporate/Funders", UserController, :corporate_funder_mgt)


    get("/View/All/collateral/Documents/Per/loan", LoanController, :view_for_collateral_documents_for_loans)
    ...
    post("/Get/All/clients/Over/Due/Loans", ReportsController, :corparate_over_due_loans_look_up)
    post("/Admin/Get/All/Over/Due/Loans", ReportsController, :get_over_due_loans_look_up)
    ...
    post("/all/innactive/clients", ReportsController, :all_innactive_clients_lookup)

    post("/admin/active/loans/by_loan_officer", ReportsController, :active_loans_by_loan_officer)
    post("/admin/due/collected/by_loan_officer", ReportsController, :due_collected_by_loan_officer)
    ...
    get("/Admin/get/all/Eod/logs/report", ReportsController, :end_of_day__totals_view)
    post("/Admin/post/all/Eod/logs/report", ReportsController, :compose_end_of_day_totals_list)
    get("/Admin/view/all/Eod/entries/report", ReportsController, :view_all_eod_entries)
    ...
    get("/Admin/view/system/users/funder/deactivate", UserController, :admin_deactivate_funder)
    post("/Admin/view/system/users/funder/deactivate", UserController, :admin_deactivate_funder)

    get("/Admin/view/system/users/deactivate/individual", UserController, :admin_deactivate_individual_funder)
    post("/Admin/view/system/users/deactivate/individual", UserController, :admin_deactivate_individual_funder)

    get("/Admin/view/system/users/activate/individual", UserController, :admin_activate_individual_funder)
    post("/Admin/view/system/users/activate/individual", UserController, :admin_activate_individual_funder)
    ...
    post("/handle/loan/bulk/upload", BulkUploadsController, :handle_loan_bulkupload)

    get("/corperate/handle/loan/bulk/upload", LoanController, :corperate_loan_bulkupload)
    post("/corperate/handle/loan/bulk/upload", CorperateBulkUploadsController, :handle_loan_bulkupload)
    ...
    post("/validate/client/bulk/upload", ClientManagementController, :validate_records_then_process)
    ...
    get("/Admin/corparate/bulk/upload", ChangeManagementController, :company_bulkupload_view)
    post("/Corparate/bulk/upload", ChangeManagementController, :handle_company_bulk_upload)
    ...
    get("/Admin/Edit/Employer/Details", OfftakerManagementController, :admin_edit_employer)
    ...
    post("/Admin/Edit/Client/Management/Employer-Maintenance", OfftakerManagementController, :edit_com_documents)
    ...
    post("/Admin/Report/All/Disbursed",ReportsController ,:last_five_disbursed_loans_lookup_miz)
    post("/Admin/Report/All/Loans/Per/Product",ReportsController ,:last_per_product_disbursed_lookup_miz)

    post("/Admin/Report/Transaction/Report",ReportsController ,:transaction_report_item_lookup)
    get("/All/pipelines/Loans/View",ReportsController, :pipeline_loans_report)
    get("/All/Loans/By/FunderView",ReportsController, :loans_report_by_funder)
    get("/All/Loans/By/OfftakererView",ReportsController, :loans_report_by_offtaker)
    post("/Admin/Pipeline/Loan/Report",ReportsController ,:loan_pipeline_report_item_lookup)

    post("/Admin/Loan/Per/Offtaker/Report",ReportsController ,:loan_per_offtaker_report_item_lookup)

    post("/Admin/disbursed/Loan/By/FunderReport",ReportsController ,:all_disbursed_loans_report_item_lookup)
  ...
  scope "/", LoanmanagementsystemWeb do
    ...
    get("/Admin/All/Loans/Report/",ReportsController ,:all_loans_by_funder_report)
    post("/Admin/All/Loans/Report/By/Funder",ReportsController ,:all_funder_loan_report_lookup)
    get("/Admin/All/Over/Due/Loans/Report/",ReportsController ,:view_all_over_due_loans_by_funder)
    post("/Admin/Get/All/Over/Due/Loans/Report/By/Funder",ReportsController ,:all_funder_over_due_loan_report_lookup)
    post("/Admin/Get/Funder/Report/All/Disbursed/Loans",ReportsController ,:last_five_disbursed_loans_lookup_per_funder)
    post("/Funder/Admin/Report/All/Loans/Per/Product",ReportsController ,:last_per_product_disbursed_lookup_per_funder)
  end
  ...
  scope "/", LoanmanagementsystemWeb do
    pipe_through([:browser, :report_app, :logged_in])

    get("/Admin/get/company/customer/statement/report", ReportsController, :corporate_loan_client_statement_report)
    get("/Admin/get/individual/customer/statement/report", ReportsController, :individual_loan_client_statement_report)
