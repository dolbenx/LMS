defmodule LoanmanagementsystemWeb.EmployeeController do
  ...
  plug LoanmanagementsystemWeb.Plugs.Authenticate,
	       ...
	       when action not in [
            ...
            :user_mgt,
            :validate_otp,
            :create_salary_advance_loan_application
	            ]
  ...
  def send_otp(conn, params) do
    ...
    client_line = conn.private.plug_session["current_user_bio_data"].mobileNumber
  ...
  def create_salary_advance_loan_application(conn, params) do
  ...
  def quick_loan_capturing(conn, params) do
    ...
    IO.inspect(params, label: "--------------------------")
      ...
      if product_type == "SALARY ADVANCE" do
        # nrc = params["nrc"]
        client_data = Loanmanagementsystem.Accounts.get_client_by_user_number(user_id)
        ...
        %{
          ...
          |> redirect(to: Routes.employee_path(conn, :all_loans))
        end
