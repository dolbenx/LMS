defmodule LoanmanagementsystemWeb.EmployeeController do
  ...
  def create_quick_loan_employee_application(conn, params) do
    ...
    if params["customer_id"] != "" || params["customer_id"] != nil do
      ...
      Ecto.Multi.new()
      |> Ecto.Multi.insert(:add_loan, Loans.changeset(%Loans{}, new_params))
      |> Ecto.Multi.run(:disburs_method, fn _repo, %{add_loan: add_loan} ->
        Loan_disbursement_method.changeset(%Loan_disbursement_method{}, %{
      ...
      Ecto.Multi.new()
      |> Ecto.Multi.insert(:add_user, User.changeset(%User{}, %{
      ...
      |> Ecto.Multi.run(:loan_application, fn _repo, %{add_user: add_user, add_user_role: _add_user_role} ->
