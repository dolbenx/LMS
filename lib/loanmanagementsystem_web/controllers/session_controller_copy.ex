defmodule LoanmanagementsystemWeb.SessionControllerCopy do
  ...
  #   query = from cl in Loanmanagementsystem.SystemSetting.ClientTelco, where: cl.domain == ^host, select: cl
