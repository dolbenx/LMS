...
use PipeTo.Override
  ...
  def loan_approval_and_disbursements(conn, _params),
    ...
    def approve_accounts_invoice_discounting_application(conn, params) do
      ...
      total_loan_recieved = params["disbursement_amount"]
      ...
      requested_amount_to_convert = try do
        ...
        total_loan_recieved_to_convert = try do
          case String.contains?(String.trim(total_loan_recieved), ".") do
            true ->  String.trim(total_loan_recieved) |> String.to_float()
            false ->  String.trim(total_loan_recieved) |> String.to_integer() end
          rescue _-> 0 end
      ...
      case total_loan_recieved_to_convert do

        total_loan_recieved_to_convert when total_loan_recieved_to_convert <= requested_amount_to_convert ->
