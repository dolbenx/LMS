defmodule LoanmanagementsystemWeb.Api.BevuraCoorperateController do
  ...
  def get_customer_lookup(conn, params) do
    response = Loanmanagement.Services.Bevura.Coorperate.customer_lookup(params)
    IO.inspect("[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]")
    IO.inspect(response)
