defmodule LoanmanagementsystemWeb.Plugs.RequireAdminAccess do
  @behaviour Plug
  import Plug.Conn
  ...
  def call(conn, _params) do
    ...
    #   |> redirect(to: Loanmanagementsystem.Router.Helpers.session_path(conn, :username))
    #   |> halt()
    # else
    #   _ -> conn
    # end
    ...
    with true <-
           is_nil(currentUserRole) ||
             (!is_nil(currentUserRole) && currentUserRole.roleType != "BANKOFFICE_ADMIN") do
      conn
