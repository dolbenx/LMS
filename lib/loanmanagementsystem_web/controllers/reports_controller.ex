defmodule LoanmanagementsystemWeb.ReportsController do
  ...
  alias Loanmanagementsystem.{Repo, Logs}
  ...
  def transaction_reports(conn, params) do
    ...
    i1 = 1
    reports = nil
    render(conn, "transaction_reports.html", reports: reports, curencies: curencies, branches: branches,  params: params, products: products, i1: i1)
  end
