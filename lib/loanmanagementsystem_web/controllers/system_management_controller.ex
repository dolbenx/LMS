defmodule LoanmanagementsystemWeb.SystemManagementController do
  ...
  plug LoanmanagementsystemWeb.Plugs.Authenticate,
        ...
        when action not in [
          ...
          :update_charge,
          :view_user_roles,
          :user_activity_listing_item_lookup
       ]
...
use PipeTo.Override
  ...
  def traverse_errors(errors),
    ...
    def user_activity_listing_item_lookup(conn, params) do
      {draw, start, length, search_params} = search_options(params)
      results = Loanmanagementsystem.Operations.user_activity_logs(search_params, start, length)
