defmodule SavingsWeb.SessionController do
  ...
  def recover_password(conn, params) do
    ...
    if system_data == nil do
      ...
      if system_data.status == "ACTIVE" do
        ...
        conn
        |> put_flash(:error, "User is Disabled, Please Contact Shimzlaw.")
  ...
  def register(conn, params) do
    user_role_id = Savings.Accounts.get_farmer_role()
    render(conn, "register.html", user_role_id: user_role_id)
  end

  def otp_validation(conn, %{"mobileNumber" => mobileNumber}) do
    user_details = Savings.Accounts.get_user_username(mobileNumber)
