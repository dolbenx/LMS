defmodule Savings.FlexcubeLogs.FlexcubeLog do
  use Ecto.Schema
  ...
  def changeset(flexcube_log, attrs) do
    flexcube_log
    |> cast(attrs, [:value_date, :refference_no, :dr_gl_account_code, :cr_gl_account_code, :amount_posted, :action_type, :endpoint, :request, :response_data, :status])
