defmodule Savings.SystemSetting do
  @moduledoc """
  ...
  alias Savings.SystemSetting.SystemSettings
  ...
  alias Savings.SystemSetting.Country
  ...
  alias Savings.SystemSetting.District
  ...
  alias Savings.SystemSetting.Province
  ...
  alias Savings.SystemSetting.ClientTelco
