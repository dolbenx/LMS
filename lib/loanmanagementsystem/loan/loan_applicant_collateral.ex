defmodule Loanmanagementsystem.Loan.Loan_applicant_collateral do
  ...
  def changeset(loan_applicant_collateral, attrs) do
    ...
    |> cast(attrs, [:customer_id, :name_of_collateral, :id_number, :color, :asset_value, :applicant_signature, :name_of_witness, :witness_signature, :cro_staff_name, :cro_staff_signature, :reference_no])
