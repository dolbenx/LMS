defmodule Loanmanagementsystem.Loan.Loan_customer_details do
  ...
  def changeset(loan_customer_details, attrs) do
    ...
    |> cast(attrs, [:customer_id, :firstname, :surname, :othername, :id_type, :id_number, :gender, :cell_number, :email, :dob, :residential_address, :landmark, :town, :province, :marital_status, :reference_no])
