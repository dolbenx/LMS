defmodule Loanmanagementsystem.RelationshipManagement.Leads do
  ...
  def changeset(leads, attrs) do
    leads
    |> cast(attrs, [:comment, :first_name, :last_name, :other_name, :title, :date_of_birth, :identification_type, :identification_number, :gender, :mobile_number, :email_address, :marital_status, :nationality, :disability_detail, :disability_status, :number_of_dependants, :userId, :bankId, :status])
    ...
    |> validate_required([:first_name, :last_name, :status, :identification_number])
