defmodule Loanmanagementsystem.Services.SalaryAdavanceUploads do
  import Ecto.Query, warn: false
  alias Loanmanagementsystem.Repo
  alias Loanmanagementsystem.Loan.Loan_application_documents
  alias Loanmanagementsystem.Logs.UserLogs

  def salary_advance_upload(%{"conn" => conn, "customer_id" => customer_id, "loan_id" => loan_id}, params) do
  ...
  defp new_route() do
    ...
    "/salary_advance/#{date_path.year}/#{date_path.month}/#{day}/"
  end
