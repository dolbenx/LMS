defmodule Loanmanagementsystem.Services.MerchantsUploads do
  import Ecto.Query, warn: false
  alias Loanmanagementsystem.Repo
  alias Loanmanagementsystem.Logs.UserLogs
  Loanmanagementsystem.Merchants.Merchants_document

  def merchant_document_upload(%{"process_documents" => files, "conn" => conn}) do
  ...
  defp new_route() do
    ...
    "/merchants_uploads/#{date_path.year}/#{date_path.month}/#{day}/"
  end
