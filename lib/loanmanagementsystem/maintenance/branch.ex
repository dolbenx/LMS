defmodule Loanmanagementsystem.Maintenance.Branch do
  ...
  def changeset(branch, attrs) do
    branch
    |> cast(attrs, [:branch_code, :branch_name, :bank_id, :is_default_ussd_branch, :status, :country_id, :province_id, :district_id, :branch_address, :approved_by, :created_by])
    |> validate_required([:branch_code, :branch_name, :bank_id, :status, :country_id, :province_id, :district_id, :branch_address, :created_by])
  end
end
