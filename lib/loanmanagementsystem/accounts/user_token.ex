defmodule Loanmanagementsystem.Accounts.UserToken do
  use Ecto.Schema
  ...
  alias Loanmanagementsystem.Accounts.{User, UserToken}
  ...
  def verify_session_token_query(token, type) do
    ...
    session_validity_in_days1 =
      Loanmanagementsystem.Workers.Utlis.NumberFunctions.convert_to_int(setting.value) || @session_validity_in_days
