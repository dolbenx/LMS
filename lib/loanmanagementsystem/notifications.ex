defmodule Loanmanagementsystem.Notifications do
  @moduledoc """
  ...
  alias Loanmanagementsystem.SystemSetting
  ...
  """
  # Loanmanagementsystem.Notifications.get_sms!(1)
  ...
  def sms_ready(status) do
    case Sms.where(
           from sms in Sms,
             where:
               sms.status == ^status and
                 sms.msg_count < ^SystemSetting.get_settings_by(Constants.sms_max_attempt()),
             limit: 50
         ) do
      nil ->
        []
