...
config :loanmanagementsystem, Loanmanagementsystem.Emails.Mailer,
  ...
  api_key: "b18b44a232efe203364b1b59fbd00b2f-2de3d545-e2705a80",
  domain: "report.probasegroup.com",
...
config :loanmanagementsystem, Loanmanagementsystem.Scheduler,
  ...
  jobs: [
    ...
    #   # 05 00 * * *
    #       # schedule: "@monthly",
    #       task: {Loanmanagementsystem.Loan, :inquire_pending_transaction_status_timex, []}
    #     ],
        ...
        daily_push_due_days: [
          ...
          schedule: "05 03 * * *",
            # schedule: "@daily",
            task: {Loanmanagementsystem.Loan, :daily_push_due_days, []}
          ],

        inquire_pending_transaction_status_timex: [
              #  schedule: "    *",
              schedule: "30 03 * * *",
                # schedule: "@daily",
                task: {Loanmanagementsystem.Loan, :inquire_pending_transaction_status_timex, []}
